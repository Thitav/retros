...
static inline void thread_context_switch(thread_context_t *current,
                                         thread_context_t *next) {
...
static inline struct capability *thread_capability(struct thread *thread,
                                                   size_t index) {
    return process_capability(thread->process, index);
}

static inline struct capability_node *
thread_capability_node(struct thread *thread) {
