...
#define PAGE_INDEXES_VADDR(pd_index, pt_index, offset) (PAGE_PD_INDEX_VADDR(pd_index) | PAGE_PT_INDEX_VADDR(pt_index) | PAGE_VADDR_PT_OFFSET(offset))

#define PAGE_PDE_PADDR(pde) ((uintptr_t)((page_directory_entry_t)(pde) & 0xFFFFF000))
#define PAGE_PTE_PADDR(pte) ((uintptr_t)((page_table_entry_t)(pte) & 0xFFFFF000))
...
static inline void page_directory_load(uintptr_t page_directory_paddr) {
    __asm__ __volatile__("movl %0, %%cr3" : : "r"(page_directory_paddr) : "memory");
}
